...
- [x] **7. GPA trend line chart / 绩点变化折线图** — Add a line chart in the Education section showing GPA change across semesters. ⚠️ _Info needed: per-semester GPA values._ / 在教育背景中加入折线图，记录各学期绩点变化。⚠️ _需提供：各学期绩点数值。_
